<template>
  ...
  >
    ...
    >
      <Icon :name="icon" class="text-3xl text-white" />
    </div>
    <h1
      class="text-darken mb-3 pt-3 text-2xl font-medium lg:h-14 lg:px-14 -translate-y-8"
    >
      {{ title }}
    </h1>
    <p class="px-4 text-gray-500 -translate-y-4">
      {{ content }}
    </p>
  </div>
</template>
...
<script setup>
const {} = defineProps(["title", "content", "icon"]);
</script>
